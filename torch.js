...
module.exports = {
  run: [
    ...
    // bump the marker suffix here AND in update.js's gate to force a
    ...
    // marker written. Old marker stays as harmless cruft until reset.js.
    {
      ...
      "params": {
        ...
        "text": "torch + Triton 3.3.1 + sage + flash installed by torch.js. Delete this file to force update.js to re-run torch.js on the next Update."
      }
    }
  ]
}
