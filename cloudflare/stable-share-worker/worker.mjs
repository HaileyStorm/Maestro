...
const RETRY_LINK = '<a class="retry" href="">Try again</a>'
const RETRY_STYLE = '.retry{display:inline-flex;align-items:center;justify-content:center;min-height:44px;margin-top:.5rem;padding:0 1rem;border:1px solid #ff9b62;border-radius:.5rem;color:#edf2ff;text-decoration:none;font-weight:600}.retry:hover{background:#ff9b621a}.retry:focus-visible{outline:3px solid #ff9b62;outline-offset:3px}'
...
</style></head><body><main><div class="ember" aria-hidden="true">◆</div><h1>Maestro is offline</h1><p>We can’t reach the studio right now.</p>${RETRY_LINK}<p class="action">Studio owner? Start Maestro from Pinokio on the studio computer.</p></main></body></html>`
