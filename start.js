...
module.exports = async (kernel) => {
  ...
  const backendEnvironment = {
    ...
    MAESTRO_ACCOUNT_STORE_PATH: effectiveEnvironmentValue("MAESTRO_ACCOUNT_STORE_PATH"),
    MAESTRO_ACCOUNT_PROJECT_MIGRATION_PATH: effectiveEnvironmentValue("MAESTRO_ACCOUNT_PROJECT_MIGRATION_PATH"),
    MAESTRO_ACCOUNT_PROJECT_MEMBERSHIP_PATH: effectiveEnvironmentValue("MAESTRO_ACCOUNT_PROJECT_MEMBERSHIP_PATH"),
